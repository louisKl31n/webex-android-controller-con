...
class Controller:
    ...
    def webex_call_from_logs(self) :
        ...
        calls.click()
        call_icon = self.find_by_XPATH('(//android.view.View[@content-desc="Appel audio, QLan 3, Travail : +33789182612"])[1]/..')
        call_icon.click()
        orange_phone_call_button = self.find_by_id('com.orange.phone:id/dialpad_floating_action_button')
        orange_phone_call_button.click()
        print('=> webex_call() success')
    ...
    def webex_send_group_im(self, group_name, target_mail, message) :
        ...
        try :
            ...
            #create the conv
            create_conversation = self.find_by_XPATH('//androidx.compose.ui.platform.ComposeView[@resource-id="com.cisco.wx2.android:id/button_compose_view"]')
            create_conversation.click()
    ...
    def webex_delete_call(self) :
        ...
        try : 
            ...
            message_tab.click()
            call = self.find_by_XPATH('//android.widget.FrameLayout[@resource-id="com.cisco.wx2.android:id/fragment_container_view"]/androidx.compose.ui.platform.ComposeView/android.view.View/android.view.View/android.view.View[1]')
    ...
    def webex_log_in_bis(self,email,password) :
        ...
        connection_button.click()
        # email_address_field = self.find_by_XPATH('//android.widget.TextView[@text="Adresse électronique"]/../..')
        email_address_field = self.find_by_XPATH('//android.widget.EditText')
        email_address_field.send_keys(email)
        next_button = self.find_by_XPATH('//android.widget.ScrollView/android.view.View/android.widget.Button')
        next_button.click()
